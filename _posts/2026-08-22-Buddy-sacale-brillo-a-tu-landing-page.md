...
Ese experimento hoy vive dentro de [arbat](https://arbatarchery.com) y lo interesante no es el juego en sí —aunque el juego sigue ahí, funcionando— sino la decisión de arquitectura que se tomó para construirlo, y que terminó convirtiendo un adorno en una pieza de infraestructura reutilizable.
