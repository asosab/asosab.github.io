---
layout: post
title:  "Convertir archivos de Microsoft Access a listas tabuladas"
date:   2017-08-04 
categories: datos
comments: true
description: "Cómo convertir de forma recursiva cualquier cantidad de archivos .mdb (archivos de base de datos access de microsoft) a .tsv (Archivos de datos tabulados)"
tags: [BBDD, linux, bash]
havecharts: false
published: false
image: bash.jpg
---

Hoy me han pasado un archivo comprimido con un montón de archivos de micosoft access. Voy a convertirlos en .tsv, que son listas de datos separados por tabulador. Es una forma de economizar espacio y es más sensillo para agregar luego a cualquier otra base de datos
